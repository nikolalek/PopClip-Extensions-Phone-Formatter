...
//     value labels: ["🇷🇺 Россия", "🇺🇸 США", "🇩🇪 Германия", "🇬🇧 Великобритания", "🇫🇷 Франция", "🇨🇳 Китай", "🇯🇵 Япония", "🇮🇹 Италия", "🇪🇸 Испания", "🇳🇱 Нидерланды", "🇸🇪 Швеция", "🇳🇴 Норвегия", "🇦🇺 Австралия", "🇨🇦 Канада", "🇧🇷 Бразилия", "🇲🇽 Мексика", "🇰🇷 Южная Корея", "🇮🇳 Индия", "🇹🇭 Таиланд", "🇵🇱 Польша", "🇹🇷 Турция", "🇸🇰 Словакия", "🇩🇰 Дания", "🇦🇹 Австрия", "🇨🇭 Швейцария", "🇧🇪 Бельгия", "🇮🇪 Ирландия", "🇵🇹 Португалия", "🇬🇷 Греция", "🇫🇮 Финляндия", "🇨🇿 Чехия", "🇭🇺 Венгрия", "🇷🇴 Румыния", "🇧🇬 Болгария", "🇭🇷 Хорватия", "🇸🇮 Словения", "🇱🇹 Литва", "🇱🇻 Латвия", "🇪🇪 Эстония", "🇨🇾 Кипр", "🇲🇹 Мальта", "🇱🇺 Люксембург"]
//     default value: RU
